...
import "@allonfire/ui/styles/globals.css";
  ...
  return (
    <html className="dark" lang="en">
      <body
        ...
        style={{
          backgroundImage:
            "radial-gradient(ellipse at center, rgba(255,136,17,0.08) 0%, transparent 60%)",
        }}
      >
        <div className="flex flex-col items-center gap-6 px-4 text-center">
          <div className="rounded-full bg-destructive/10 p-5">
            <Flame className="size-20" style={{ color: "#FF8811" }} />
          </div>
