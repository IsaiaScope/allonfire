---
name: remotion
description: Use when working on Remotion video code, React compositions, frame-based animation, render checks, captions, media assets, transparent videos, or video export workflows.
metadata:
